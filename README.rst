...
2. Run ``cookiecutter`` on the template::
    ...
    $ cookiecutter https://github.com/beeware/Python-iOS-template --checkout 3.7
...
.. _Download the Python Apple support package for iOS: https://briefcase-support.s3-us-west-2.amazonaws.com/python/3.7/iOS/Python-3.7-iOS-support.b2.tar.gz
