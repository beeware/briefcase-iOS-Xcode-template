...
2. Run ``cookiecutter`` on the template::
    ...
    $ cookiecutter https://github.com/beeware/briefcase-iOS-Xcode-template --checkout 3.7
...
.. _Download the Python Apple support package for iOS: https://briefcase-support.org/python?platform=iOS&version=3.7
