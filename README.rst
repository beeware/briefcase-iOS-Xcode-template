...
2. Run ``cookiecutter`` on the template::
    ...
    $ cookiecutter https://github.com/beeware/Python-iOS-template --checkout 3.8
...
.. _Download the Python Apple support package for iOS: https://briefcase-support.s3-us-west-2.amazonaws.com/python/3.8/iOS/Python-3.8-iOS-support.b1.tar.gz
